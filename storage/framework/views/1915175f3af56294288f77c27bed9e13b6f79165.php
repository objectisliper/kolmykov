    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo route('about.show'); ?>">О компании</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo route('categories.show'); ?>">Публикации</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo route('contact.show'); ?>">Контакты</a>
                </li>
            </ul>
        </div>
    </div>
